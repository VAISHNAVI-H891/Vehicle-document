...
<html>
    <head>
        <title>QR CODE BASED VEHICLE TRACKING SYSTEM</title>
        <!-- for-mobile-apps -->
        ...
        <div class="products-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li>WELCOME TO QR CODE BASED DOCUMENT VERIFICATION OF  VEHICLES</li>
                </ul>
            </div>
        </div>
        <!-- //products-breadcrumb -->
...
<?php //include('navigation_bar.php');   ?>
            <div class="">
                ...
                <div class="w3_login">
                    <h3>WELCOME TO QR CODE  BASED DOCUMENT VERIFICATION OF VEHICLES</h3>
