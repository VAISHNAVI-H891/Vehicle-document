...
$sql = 'SELECT * FROM qr_code_missing_bike';
    ...
    <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <a href="add_complaint.php"><h3 class="box-title">ADD NEW</h3></a>
            </div>
          <div class="box box-success">
            <div class="box-header with-border">
			...
			<th>Owner Name</th> 
               ...
               <tr>
				 ...
				 <td><?php echo $row['complete_date'];            ?></td>
				  ...
				  <td><?php echo $row['desc_details'];            ?></td>
				   <td><?php echo $row['complete_station'];            ?></td>
